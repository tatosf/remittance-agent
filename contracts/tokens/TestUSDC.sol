...
/**
 * @title TestUSDC
 * @dev An ERC20 token that simulates USDC for testing purposes
...
contract TestUSDC is ERC20, Ownable {
        ...
        Ownable(msg.sender)
    {
        ...
        _mint(msg.sender, 1000000 * 10**_decimals); // 1 million tUSDC
    }
     ...
     * @param amount Amount of tokens to mint (in the smallest unit, e.g., 1000000 = 1 tUSDC)
     */
    function mint(uint256 amount) external {
        require(amount <= 10000 * 10**_decimals, "Can't mint more than 10,000 tUSDC at once");
